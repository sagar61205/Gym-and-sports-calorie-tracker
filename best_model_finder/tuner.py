...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        ...
        try:
            ...
            self.param_grid = {"n_estimators": [10, 100,500,700], "criterion": ['mse'],
    ...
    def get_best_params_for_xgboost(self,train_x,train_y):
        ...
        try:
            ...
            self.param_grid_xgboost = {
                ...
                'max_depth': [3, 5, 10],
                'n_estimators': [10, 300,500,700,1000],
            ...
            # creating a new model with the best parameters
            self.xgb = XGBRegressor(learning_rate=self.learning_rate, max_depth=self.max_depth, n_estimators=self.n_estimators,booster=self.booster)
            # training the mew model
