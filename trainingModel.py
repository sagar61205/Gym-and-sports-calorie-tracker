...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            data = preprocessor.dropUnnecessaryColumns(data,['Id','ActivityDate','TotalDistance','TrackerDistance','LoggedActivitiesDistance','SedentaryActiveDistance'])
            ...
            # scale the training data as per EDA
            #data_scaled = pandas.DataFrame(preprocessor.RobustScalingData(data), columns=data.columns)
            ...
            for i in list_of_clusters:
                ...
                x_train_scaled = preprocessor.squareroot(x_train)
                x_test_scaled = preprocessor.squareroot(x_test)
